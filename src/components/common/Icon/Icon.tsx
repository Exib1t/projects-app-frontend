...
const Icon: FC<Props> = ({ type, fontSize, ...rest }) => {
  const iconClass = useThemeMode();
  const className = `${iconClass}__icon`;
  ...
  switch (type) {
    ...
    case "sort-up":
      return (
        ...
        >
          ...
          />
          <path
            d="M12.1199 22.1488H19.2929V20.5548H13.8614L19.2929 15.5371V13.3818H12.5184V14.9758H17.5514L12.1199 19.9935V22.1488Z"
            fill="#181818"
          />
          <path
    ...
    case "sort-down":
      return (
        ...
        >
          <path
            d="M2.00549 10.028L6.60422 5.42943V42.4412H9.44058V5.42943L14.0393 10.0281L16.0449 8.02249L8.0224 0L0 8.02249L2.00549 10.028Z"
            fill="#181818"
          />
          <path
            d="M34.3301 23.2957H22.2755V26.132H31.2313L21.5664 35.0606V38.8957H34.3301V36.0593H24.6651L34.3301 27.1308V23.2957Z"
            fill="#181818"
          />
          <path
    ...
    case "priority-medium":
      return (
        ...
        >
          <path
            d="M4 7.53564L7.53553 4.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
          <path
            d="M11.071 7.53564L7.53551 4.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
          <path
            d="M4 10.5356L7.53553 7.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
          <path
            d="M11.071 10.5356L7.53551 7.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
        </SvgIcon>
    ...
    case "priority-low":
      return (
        ...
        >
          <path
            d="M4 9.53564L7.53553 6.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
          <path
            d="M11.071 9.53564L7.53551 6.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
        </SvgIcon>
    ...
    case "priority-high":
      return (
        ...
        >
          ...
          />
          <path
            d="M4 6.53564L7.53553 3.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
          <path
            d="M11.071 6.53564L7.53551 3.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
          <path
            d="M4 12.5356L7.53553 9.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
          <path
            d="M11.071 12.5356L7.53551 9.00011"
            stroke="#DBA34E"
            strokeLinecap="round"
          />
        </SvgIcon>
    ...
    case "back":
      return (
        ...
        >
          ...
          />
          <path
            d="M6.43 10.8099L3.87 8.24994L6.43 5.68994"
            stroke="#181818"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
