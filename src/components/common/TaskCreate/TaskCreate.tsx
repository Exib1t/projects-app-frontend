    ...
    >
      ...
      <Stack direction="row" gap={1} alignItems="center">
        ...
        <FormControl size="small" sx={{ width: '50%' }}>
          ...
          <Select value={task.type} name="type" label="Type" onChange={handleInputChange} required>
      ...
      <Stack direction="row" gap={1} alignItems="center">
        ...
        <FormControl size="small" sx={{ width: '50%' }}>
          ...
          <Select value={task.priority} name="priority" label="Priority" onChange={handleInputChange} required>
            <MenuItem value={1} sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
